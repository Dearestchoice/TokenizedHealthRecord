...
import { LockIcon, MailIcon } from "../Login/Icons";
  ...
  return (
    <main className="flex-1 flex items-center justify-center">
      <div className="bg-[#15192B] p-8 md:p-12 md:min-w-[450px] rounded-lg shadow-lg text-white">
        <h2 className="text-xl font-semibold mb-2 font-sora">Create Account</h2>
        <p className="mb-6 font-medium">Welcome! Select method to sign up</p>
        ...
        <p className="text-center text-gray-400 mt-6">
          ...
          <Link to={"/login"} className="text-thrGreen hover:underline">
            Sign in
          </Link>
        </p>
      </div>
